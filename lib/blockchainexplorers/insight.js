...
var WebSocketClient = require('./insight-ws');
...
function Insight(opts) {
  ...
  this.webSocketClient = new WebSocketClient(opts.useSocketIo || false, opts.webSocketsUrl, Insight.prototype.getConnectionInfo);
  ...
  this.webSocketsUrl = opts.webSocketsUrl;
}
...
Insight.prototype.getTxidsInBlock = function(blockHash, cb) {
  ...
  var args = {
    method: 'GET',
    path: this.apiPrefix + '/block/' + blockHash + '?noTxList=0',
    json: true,
  };
...
Insight.prototype.initSocket = function() {
  return this.webSocketClient.initSocket();
};
